...
const FaqComponent = (props: FaqComponentProps) => {
  ...
  return (
    <motion.div
      layout
      className={` flex items-start justify-around  lg:w-[500px] rounded-[20px] border border-[#E6E9EA] transition-all p-2 ${
        active
      ...
      <div className="w-[85%] h-full">
        <p className="font-marope text-[20px] leading-[24px] text-[#1E242C] mb-4 ml-2">
          {props.header}
        </p>
        {active && (
          <motion.p
            ...
            className="font-marope font-normal text-[16px] leading-[24px]">
            {props.text}
          </motion.p>
        )}
      </div>
...
const Faq = (props: Props) => {
  return (
    <div className="px-32 py-16 bg-white">
      ...
      <div className="h-[390px] w-full bg-gradient-bg bg-cover bg-no-repeat my-16 rounded-[24px] shadow-shadow-success p-8">
        <div className="w-full  flex flex-col justify-center items-center">
          <p className="font-marope font-medium text-[40px] leading-[48px] text-center w-[70%]">
            Boost Your Academic Success: Join Our Newsletter for the Latest
            Updates
          </p>
          <p className="font-marope text-[16px] leading-[24px] text-center text-[#414D60] w-[50%] my-2">
          ...
          <div>
            <div className="flex items-center my-4">
              <div className="w-[300px] h-[60px] rounded-[56px] bg-white flex items-center shadow-input-shadow px-2 mr-2">
